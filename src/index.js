  ...
  <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
    ...
    <div className>
      <div>
        ...
        <input className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="text" placeholder="Your Full Name" />
      </div>
      <div className="mt-8">
        <span className="uppercase text-sm text-gray-600 font-bold">Email</span>
        <input className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="text" placeholder='Your Email' />
      </div>
      <div className="mt-8">
        <span className="uppercase text-sm text-gray-600 font-bold">Message</span>
        <textarea className="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" defaultValue={""} placeholder='What can we help you with today?'/>
      </div>
      <div className="mt-8">
...
{/* //////////// */}
  ...
  {/* <div className="my-11 w-full ">
                <div className="w-full sm:w-2/4  px-20 sm:px-15  leading-8  border-white-400 pt-10 mx-auto bg-white  md:grid-cols-2 lg:grid-cols-3">
                    <section className="text-gray-600   body-font relative">
                        <div className="container px-2 py-4">
                            <div className="flex flex-col text-center w-full mb-6">
                                <h1 className="sm:text-3xl text-2xl  font-medium title-font mb-4 text-black">What's on your mind?</h1>
                                <p className="lg:w-2/3 mx-auto leading-relaxed text-black">Say hello, send us cat gifs, or ask us anything using this contact from
                                    and we'll respond within 24 hours (usually).</p>
                                ...
                                <div className="flex flex-wrap -m-2 ">
                                    <div className="p-2 w-full sm:w-1/2">
                                        <div className="relative ">
                                            ...
                                            <input type="text" id="name" placeholder=" Your First Name" name="name" className="w-full bg-gray-100 placeholder-black placeholder-opacity-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                        </div>
                                    </div>
                                    <div className="p-2 w-full sm:w-1/2">
                                        <div className="relative">
                                            <label htmlFor="name" className="leading-7 text-sm text-black">Last Name*</label>
                                            <input type="text" id="email" placeholder="Your Last Name" name="email" className="w-full bg-gray-50 placeholder-black placeholder-opacity-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-2 w-full">
                                        <div className="relative">
                                            <label htmlFor="message" className="leading-7 text-sm text-black">Email Address*</label>
                                            <input type="email" id="email" placeholder=" Your Email Address" name="email" className="w-full bg-gray-100 placeholder-black placeholder-opacity-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                        </div>
                                    </div>
                                    <div className="p-2 w-full">
                                        <div className="relative">
                                            <label htmlFor="message" className="leading-7 text-sm text-black">Message*</label>
                                            <textarea id="message" name="message" placeholder="What can we help you with today?" className="w-full bg-gray-100 placeholder-black placeholder-opacity-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out" defaultValue={""} />
                                        </div>
                                    </div>
                                    <div className="p-2 w-full">
                                        <button className="w-3/6 sm:w-2/6  flex justify-center  text-white bg-black border-0 py-2 px-2 sm:px-8 focus:outline-none hover:bg-indigo-600  rounded text-sm">SEND MESSAGE</button>
                                    </div>
                                </div>
                            </div>
                        </div>
